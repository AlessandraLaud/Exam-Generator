        ...
        loadButton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(window, "Exam file was not found.", "Error", JOptionPane.WARNING_MESSAGE);
                ...
                if(exam == null) {
                    ...
                    // print exam to file
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Exam failed to be printed", "Error", JOptionPane.INFORMATION_MESSAGE);
                        }
            ...
            public void actionPerformed(ActionEvent e) {
                if(exam == null) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(window, "Question was not added.", "Error", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                if(exam == null) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Question number does not exist. Please select an already existing question.", "Error", JOptionPane.INFORMATION_MESSAGE);
                    }
                    catch(Exception ex) {
                        JOptionPane.showMessageDialog(null, "A question was not removed.", "Error", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        });
