    ...
    public void addQuestion() {
        ...
        if(questionType == 0 || questionType == 1) {
            ...
            // MC MA
                ...
                // check if baseCredit is an int
                Integer.parseInt(baseCredit);
                if(baseCredit == null)   
                {
                    throw new IllegalArgumentException("Cancel");
                }
                ...
                for(int i = 0; i < Integer.parseInt(numAnswers); i++) {
                    ...
                    creditIfSelected = JOptionPane.showInputDialog("Enter the amount of credit if this answer is selected:");
                    // check if creditIfSelected is an int
                    Integer.parseInt(creditIfSelected);
        ...
        // SAQuestion and NumQuestion
            ...
            // Essay Numerical Answer
                ...
                // check if numberAnswer is an int
                Integer.parseInt(numberAnswer);
